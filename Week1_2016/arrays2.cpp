 ...
 *
 *@param *arr: pointer to first element of arr
...
int main(int argc, char ** argv)
{
    ...
    cout << "The max value in this array is " << findMax(&(test_values[0]), real_size) << endl << endl;
    ...
    cout << "The arithmetic mean of this array is " << findMean(&(test_values[0]), real_size) << endl << endl;
    cout << "After replacing the elements in the array with an ascending sequence we get..." << endl;
    replaceWithAscending(&(test_values[0]), real_size);
    cout << "[";
    for (int i = 0; i < real_size; i++)
    {
        if (i == real_size - 1)
