/*Every chunk of memory that is dynamically allocated using the new syntax must be deallocated
or deleted or else it could cause a memory leak. In this example, the destructor for the linked
list does not go through the list and deallocate each node.*/
